	...
	short player_index)
{
	...
	// PROMO/DEBUG (DISABLED -- was: grant every weapon + ammo on spawn for promo screenshots / level
	// hopping). Commented out to remove the promo behavior; uncomment to re-enable. See [[promo-temp-changes]].
